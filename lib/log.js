...
(function() {
  var Logger, MESSAGE, basename, createLogger, stderr, winston;
  ...
  Logger = class Logger {
    ...
    console(...xs) {
      if (xs != null ? xs[0] : void 0) {
        return this.logger.console.apply(this.logger, xs);
      }
    }

    error(...xs) {
      if (xs != null ? xs[0] : void 0) {
        return this.logger.error.apply(this.logger, xs);
      }
    }

    warn(...xs) {
      if (xs != null ? xs[0] : void 0) {
        return this.logger.warn.apply(this.logger, xs);
      }
    }

    info(...xs) {
      if (xs != null ? xs[0] : void 0) {
        return this.logger.info.apply(this.logger, xs);
      }
    }

    verbose(...xs) {
      if (xs != null ? xs[0] : void 0) {
        return this.logger.verbose.apply(this.logger, xs);
      }
    }

    spawn(...xs) {
      if (xs != null ? xs[0] : void 0) {
        return this.logger.spawn.apply(this.logger, xs);
      }
    }
