...
(function() {
  var CfnError, CfnTransformer, ResourceTypes, YamlTransformer, assert, fn, fs, indexOfClosingCurly, interpolateSub, log, os, parseKeyOpt, parseKeyOpts, path, topLevelResourceProperties, yaml,
    indexOf = [].indexOf;
  ...
  CfnTransformer = class CfnTransformer extends YamlTransformer {
    ...
    bindings() {
      return Object.assign({}, this.bindstack[this.bindstack.length - 1]);
    }
    ...
    transformTemplateFile(file) {
      var ret, xformer;
      xformer = new this.constructor({basedir: this.basedir, cache: this.cache, opts: this.opts, maps: this.maps});
