...
(function() {
  var CfnError, CfnTransformer, ResourceTypes, YamlTransformer, assert, fn, fs, indexOfClosingCurly, interpolateSub, log, os, parseKeyOpt, parseKeyOpts, path, spawnSync, topLevelResourceProperties, yaml,
    indexOf = [].indexOf;
  ...
  CfnTransformer = class CfnTransformer extends YamlTransformer {
    constructor({
      ...
      this.defmacro('Ref', 'Ref', (form) => {
        ...
        if (fn.isString(form)) {
          ...
          switch (false) {
            ...
            case fn.peek(this.bindstack)[ref] == null:
              return fn.getIn(this.walk(fn.peek(this.bindstack)[ref]), ks);
            default:
              return {
                Ref: form
              };
      ...
      this.defspecial('Let', (form) => {
        ...
        if (fn.isArray(form)) {
          ...
          fn.merge(fn.peek(this.bindstack), fn.assertObject(this.walk(form)));
          return null;
        }
      });
      ...
      this.defmacro('Shell', (form) => {
        var env, vars;
        [form = '', vars = {}] = fn.isArray(form) ? form : [form];
    ...
    handleShell(cmd, res, raw) {
      ...
      stdout = fn.rmCR((ref1 = res.stdout) != null ? ref1.toString('utf-8') : void 0);
      stderr = fn.rmCR((ref2 = res.stderr) != null ? ref2.toString('utf-8') : void 0);
    ...
    execShellArgs(cmd, args, opts, raw = false) {
      var res;
      res = spawnSync(cmd, args, fn.merge({
        stdio: 'pipe',
        shell: '/bin/bash'
      }, opts));
      return this.handleShell(cmd, res, raw);
