...
(function() {
  var CfnError, abortOnException, assert, assertArray, assertObject, assertOk, assertString, assoc, conj, crypto, dbg, deepEqual, deepMerge, execShell, execShellArgs, fileExt, fs, getIn, handleShell, hashMap, identity, invertObj, isArray, isBoolean, isCollection, isDirectory, isNull, isNumber, isObject, isRef, isScalar, isString, isUndefined, log, md5, md5Dir, md5File, md5Path, merge, mergeStrings, notEmpty, objKeys, objVals, os, partial, path, peek, prependLines, readFile, reduceKv, rmCR, selectKeys, spawnSync, split, tmpdir, tryExecRaw, typeOf,
    indexOf = [].indexOf;
