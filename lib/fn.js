...
(function() {
  var CfnError, MOCKS, TESTING, WHITELIST, abortOnException, assert, assertArray, assertObject, assertOk, assertString, assoc, conj, crypto, dbg, deepEqual, deepMerge, execShell, execShellArgs, fileExt, fs, getIn, handleShell, hashMap, identity, invertObj, isArray, isBoolean, isCollection, isDirectory, isNull, isNumber, isObject, isRef, isScalar, isString, isUndefined, log, md5, md5Dir, md5File, md5Path, merge, mergeStrings, mockShell, noMockShell, notEmpty, objKeys, objVals, os, partial, path, peek, prependLines, readFile, reduceKv, rmCR, selectKeys, spawn, spawnSync, split, testing, tmpdir, tryExecRaw, typeOf, whiteListed,
    indexOf = [].indexOf;
